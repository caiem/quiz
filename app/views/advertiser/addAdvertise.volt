            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive no-padding">
                        <form class="form-horizontal" action="/Advertise/add" id="form_post">
                          <!-- 新增广告 -->
                          <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="ad_name" value="{% if adInfo['ad_name'] is defined %}{{adInfo['ad_name']~'-copy-'~date('ndHi')}}{% endif %}">
                                    </div>
                                  ...
                                  <div class="col-sm-6">
                                    <select name="belongto" class="form-control">
                                      {% for key,item in agentLists%}
                                        <option value="{{item['user_id']}}"  {% if adInfo['belong_to'] is defined and adInfo['belong_to']==item['user_id']%}selected{% endif %}>{{item['realname']}}</option>
                                      {% endfor %}
                                    </select>
                                  </div>
                                  <div class="col-sm-4 notice_gray">请选择代投企业，选择后该代投企业可以看到该广告。注：一旦选定不可更改，如果下拉没数据请先做<a href="/Advertise/accounts">代投企业账户设置</a></div>
                                </div>
                                {% endif %}
                                <div class="form-group p_notice">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <label class="radio-inline">
                                            <input name="target" type="radio" value="{{key}}" {% if adInfo['target'] is defined and key== adInfo['target'] or adInfo['target'] is not defined and key==1 %}checked{% endif %}>{{item}}    
                                        </label>
                                        {% endfor %}
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <table class="table table-hover">
                                            ...
                                            <tbody class="target-config wap-config {% if adInfo['target'] is defined and 2!= adInfo['target']  or adInfo['target'] is not defined%}hidden{%endif%} ads_tpyes" style="display:block; max-height:200px;overflow-y: scroll;">
                                                ...
                                                {% if item['target']==2 %}
                                                <tr><td width="240"><input data-content='{{item|json_encode}}' name="kk" type="radio"/>{{item['name']}}</td><td width="120">{{ item['target']!=2 ? advertiseType[item['ad_type']] :advertiseTypeWap[item['ad_type']] }}</td><td>{{item['ad_size']}}{{item['ad_type']!='inforflow'?'单图':'多图'}}</td></tr>
                                                {% endif %}
                                                {% endfor %}
                                            </tbody>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="ad_preview col-sm-6">
                                        <a class="viewImg" href="/dist/img/nopic.gif"><img style="max-height:80px;max-width:520px" src="/dist/img/nopic.gif"  ></a>
                                    </div>
                                </div>
                                <div class="form-group p_notice">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <label id="edit_cost_type_{{key}}" class="radio-inline">
                                            <input name="cost_type" type="radio" value="{{key}}" {% if adInfo['cost_type'] is defined and adInfo['cost_type']==key or adInfo['cost_type'] is not defined and 1==key%}checked{% endif %}>{{item}}
                                        </label>
                                        {% endfor %}
                                    </div>
                                ...
                                <div class="form-group p_notice target-config app-config {% if adInfo['target'] is defined and 1!= adInfo['target']%}hidden{%endif%}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <label class="radio-inline">
                                            <input name="platforms" type="radio" value="{{key}}" {% if adInfo['platforms'] is defined and adInfo['platforms']==key%}checked{%endif%}>{{item}} 
                                        </label>
                                        {% endfor %}
                                    </div>
                                ...
                                <div class="form-group p_notice">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="ugoup_select" id="ugoup-select" class="form-control"></select>
                                    </div>
                                    <div class="col-sm-4 notice_gray">选择定向条件。可以直接选择已有的分组或重新创建<span class="cost_cpm red"></span></div>
                                </div>
                                ...
                                <div class="target-config app-config {% if adInfo['target'] is defined and 1!= adInfo['target']%}hidden{%endif%}">
                                    <div class="cost_cpc p_notice">
                                        <div class="form-group ios-pt">
                                            ...
                                            <div class="col-sm-4 notice_gray">IOS端CPC点击单价,建议最低出价：<label class="ppnote">-</label></div>
                                        </div>
                                        <div class="form-group android-pt">
                                            ...
                                            <div class="col-sm-4 notice_gray">Android端CPC点击单价,建议最低出价：<label class="ppnote">-</label></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="target-config app-config {% if adInfo['target'] is defined and 1!= adInfo['target']%}hidden{%endif%}">
                                    <div class="cost_cpm p_notice">
                                        <div class="form-group ios-pt">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" name="ios_totals" value="{{adInfo['ios_totals']|default('')}}">
                                            </div>
                                            <div class="col-sm-4 notice_gray">必填。IOS端计划要达到的CPM,单位为个。<span class="red">注：一旦选定后不可更改</span><span class="cost_cpm red">，CPM单价：<label class="ppnote">-</label></span></div>
                                        </div>
                                        <div class="form-group android-pt">
                                            <label class="col-sm-2 control-label" for="formGroupInputLarge">Android-目标CPM</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" name="android_totals" value="{{adInfo['android_totals']|default('')}}">
                                            </div>
                                            <div class="col-sm-4 notice_gray">必填。Android端计划要达到的CPM,单位为个。<span class="red">注：一旦选定后不可更改</span><span class="cost_cpm red">，CPM单价：<label class="ppnote">-</label></span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="target-config wap-config {% if adInfo['target'] is defined and 2!= adInfo['target']  or adInfo['target'] is not defined%}hidden{%endif%}">
                                ...
                                <div class="target-config wap-config {% if adInfo['target'] is defined and 2!= adInfo['target']  or adInfo['target'] is not defined%}hidden{%endif%}">
                                    <div class="form-group cost_cpm p_notice">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text" name="wap_totals" value="{{adInfo['wap_totals']|default('')}}">
                                        </div>
                                        <div class="col-sm-4 notice_gray">必填。网页计划要达到的CPM,单位为个。<span class="red">注：一旦选定后不可更改</span><span class="cost_cpm red">，CPM单价：<label class="ppnote">-</label></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control Wdate" style="display:inline;width:48%" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" size="30" name="begin_time">
                                        <span class="cost_cpc">到
                                        <input class="form-control Wdate" style="display:inline;width:48%" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" size="30" name="end_time">
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" style="display:inline;width:48%" type="number" min="0" max="23" name="begin_hour">到
                                        <input class="form-control" style="display:inline;width:48%" type="number" min="0" max="23" name="end_hour">
                                    </div>
...
$(document).ready(function(){
  $(".setting").click(function(){
    ...
    if(checkInput()){
        $.post({
            ...
            .done(function (data) {
              if (data.code == 200) {
                window.location.href="/Advertise/source?id="+data.result;
              } else {
                alert(data.msg);
              }
            });
  ...
  initAdPreview();
  initCostType();
  $('input[name=cost_type]').on('change',function(){
    initCostType()
  })
  {% if isAgent is not empty %}
  getbalance()
  $('select[name=belongto]').on('change',function(){
    getbalance()
  })
  {% endif %}
});
